class Game < ApplicationRecord
	def self.start()
	    ...
	    if Rails.cache.read("players").length != 3
		    ...
		    kickoff_message = "Everyone is ready! Let's start the game. <br>"+first+" is first. They will roll the dice now. Next will be "+second+". "+third+" is last."
